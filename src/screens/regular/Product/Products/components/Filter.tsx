...
import { getProductCategoryInfo } from "@store/selector/product";
...
export interface optionProps {
  visible: boolean;
  onClose: () => void;
  onSubmit: (params: productFilterState | null) => void;
}
...
export default ({ onClose, visible, onSubmit }: optionProps) => {
  ...
  const [filter, setFilter] = useState<filterProps>({ priceRange: "50" });
